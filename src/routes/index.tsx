...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Vancouver luxury real estate engineered with data, executed with discretion." },
    ],
  }),
  component: HomePage,
});
      ...
      <div className="relative min-h-screen overflow-hidden flex items-center justify-center">
        ...
        <SectionShell className="relative z-10 w-full">
          <div className="glass-panel max-w-3xl mx-auto p-10 md:p-16 text-center space-y-8 rounded-sm">
            ...
            <Reveal delay={120}>
              <h1 className="font-serif text-[#FDFCFB] leading-[1.05] font-normal" style={{ fontSize: "clamp(2.5rem, 6vw, 4.75rem)" }}>
                Strategic Asset <em className="italic font-normal text-[#C5A267]">Marketing.</em> Data-Driven Execution.
              </h1>
            </Reveal>
            <Reveal delay={240}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <Reveal>
            <div className="space-y-6 max-w-lg">
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-[#FDFCFB] leading-tight">Avi Sanan</h2>
              <p className="text-sm text-[#FDFCFB]/70 font-sans leading-relaxed">
                As a real estate advisor with a strong foundation in Commerce, Avi brings an analytical and strategic approach to marketing luxury assets. His methodology goes beyond aesthetics, focusing on precise market positioning and demographic targeting to secure optimal outcomes for his clients.
              </p>
            </div>
          </Reveal>
          <Reveal delay={150}>
            <div className="w-full aspect-[4/5] md:max-w-[400px] mx-auto md:ml-auto relative">
              <div className="hero-frame-elevated h-full">
                <PlaceholderFrame ratio="4/5" label="Executive Portraiture" description="Polished modern executive headshot of Avi Sanan." className="h-full border-0" />
              </div>
            </div>
          </Reveal>
        </div>
