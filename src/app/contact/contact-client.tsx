        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div className="space-y-2 border-t border-[#C5A267]/10 pt-6">
              <p className="text-[10px] tracking-[0.28em] uppercase text-[#FDFCFB]/55">Office</p>
            ...
            <div className="space-y-3 border-t border-[#C5A267]/10 pt-6">
              ...
              <a
                ...
                className="block text-sm text-[#FDFCFB]/80 hover:text-[#C5A267]"
              >
              ...
              <IntakeForm
                ...
                fields={[
                  ...
                  },
                  {
                    ...
                    type: "select",
                    options: ["Today", "Tomorrow", "Within 48 hours", "This week"],
